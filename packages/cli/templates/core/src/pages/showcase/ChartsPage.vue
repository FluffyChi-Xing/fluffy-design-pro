...
const option = computed(() => ({
  ...
  series: [
    { name: 'Requests', type: 'line', smooth: true, data: [84, 119, 92, 158, 141, 187, 206] },
    { name: 'Deployments', type: 'bar', barMaxWidth: 26, data: [12, 18, 15, 25, 21, 30, 35] }
  ]
}))
useChart(chartElement, { modules: [BarChart, CanvasRenderer, GridComponent, LegendComponent, LineChart, TooltipComponent], option })
</script>
