...
describe('createProject', () => {
  it('generates a Vue project, manifest, and default Vercel configuration', async () => {
    ...
    expect(manifest.files).toEqual(expect.arrayContaining([
      ...
      expect.objectContaining({ path: 'src/components/extensions/FCrop.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FMasonry.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FWatermark.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FQrcode.vue' }),
    ...
    expect(manifest.files).toEqual(expect.arrayContaining([
      ...
      expect.objectContaining({ path: 'src/components/extensions/FCrop.vue', owner: 'generator-owned', templatePath: 'src/components/extensions/FCrop.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FMasonry.vue', owner: 'generator-owned', templatePath: 'src/components/extensions/FMasonry.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FWatermark.vue', owner: 'generator-owned', templatePath: 'src/components/extensions/FWatermark.vue' }),
      expect.objectContaining({ path: 'src/components/extensions/FQrcode.vue', owner: 'generator-owned', templatePath: 'src/components/extensions/FQrcode.vue' }),
